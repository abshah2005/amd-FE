...
const questionData = [
  {
    ...
    question: 'What legal steps should I take before raising a seed round as a first-time founder?',
    professional: {
      name: 'Alex Hales',
...
6. Compliance: Ensure you're compliant with securities regulations.`,
  ...
  },
  {
    ...
    deliveryTime: 'Normal',
    attachedImages: [
      { url: '/images/remote-team.jpg', label: 'Image 1' }
    ],
    answer: {
...
const QuestionsPage = () => {
  ...
  .filter(q => activeTab === 'Active'
    ? q.status !== 'Declined' && q.status !== 'Accepted' // or your logic for active
    : q.status === 'Declined' || q.status === 'Accepted' // or your logic for archived
  )
  .filter(question =>
    question.question.toLowerCase().includes(searchTerm.toLowerCase()) ||
    question.professional.name.toLowerCase().includes(searchTerm.toLowerCase())
  );
      ...
      <div className="md:w-[91%] mx-auto">
        ...
        <div className="mt-4 flex justify-between items-center">
          <div className="text-sm text-gray-500">
            Showing {filteredQuestions.length} of {questionData.filter(q => activeTab === 'Active'
