...
const SignUpPage = () => {
  ...
  return (
    <div className="h-screen bg-[#F0F1F3] flex flex-col overflow-hidden">
      ...
      {/* Main Content - now using h-full and flex-col to prevent scrolling */}
          ...
          <div className="max-w-6xl w-full flex">
            ...
            <div className="w-full md:w-1/2 flex items-center justify-center">
              <div className="bg-white w-full max-w-sm rounded-lg shadow-sm p-8 ">
                <button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-md flex items-center justify-center mb-6">
                  <svg
                ...
                <form className="space-y-4">
                  ...
                  <button
                    ...
                    disabled={!hasMinLength || !hasNoSpaces}
                    style={{
                      opacity: !hasMinLength || !hasNoSpaces ? 0.7 : 1,
                      cursor:
                        !hasMinLength || !hasNoSpaces
                          ? "not-allowed"
                          : "pointer",
                    }}
                  >
