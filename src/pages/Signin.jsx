...
const SignInPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F0F1F3] flex flex-col items-center ">
      {/* Navbar */}
      <nav className="w-full z-10 mb-0">
        <div className="max-w-6xl py-4 px-6 flex justify-start">
          <img src={logo} className="w-28" alt="Logo" />
        </div>
      </nav>

      <div className="bg-white w-full max-w-xs rounded-lg shadow-sm p-6 ">
        ...
        <form className="space-y-3" onSubmit={handleSignIn}>
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            >
              Forgot your <span className="font-medium">password</span>?
            </a>
          </div>
          <button
            type="submit"
      ...
      <footer className="bg-[#F0F1F3] py-4 text-center text-xs text-gray-500 flex justify-center items-center ">
        <p>
