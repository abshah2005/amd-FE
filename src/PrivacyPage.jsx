    ...
    <div className=" min-h-screen py-10 px-10">
      <div className="w-full mx-auto bg-white   p-8">
        ...
        <p className="text-gray-700 mb-6">
          AskMeDirect ("we", "our", or "us") is committed to protecting your
          privacy. This Privacy Policy explains how we collect, use, and
          safeguard your information when you use our website, platform, and
          services (collectively, the "Services"). By using AskMeDirect, you
        ...
        <div className="mb-6">
          ...
          <ul className="list-disc list-inside text-gray-700 pl-5">
            <li>
              Account details (name, email address, password, profile
              information).
            </li>
            <li>
              Payment and payout details (handled securely by third-party
              providers like Stripe).
            </li>
            <li>
              Questions, answers, and other content shared on the platform.
            </li>
          </ul>
        </div>
        <div className="mb-6">
          ...
          <ul className="list-disc list-inside text-gray-700 pl-5">
            ...
            <li>
              Cookies and similar technologies (for site functionality and
              analytics).
            </li>
          </ul>
        </div>
        <div className="mb-6">
          ...
          <ul className="list-disc list-inside text-gray-700 pl-5">
            <li>
              If you sign up using LinkedIn or other integrations, we may
        ...
        <div className="mb-6">
          <ul className="list-disc list-inside text-gray-700 pl-5">
            ...
            <li>
              Ensure trust and safety (fraud detection, dispute resolution, and
              compliance).
            </li>
        ...
        <div className="mb-6">
          <ul className="list-disc list-inside text-gray-700 pl-5">
            <li>
              With service providers (e.g., Stripe for payments, hosting
              providers, analytics tools).
            </li>
            <li>
              With other users (e.g., profile details shared publicly, your
              submitted questions/answers).
            </li>
            <li>
              For legal reasons (if required by law, regulation, or to protect
              the rights, safety, or property of AskMeDirect and our users).
            </li>
            <li>
        ...
        <div className="mb-6">
          <p className="text-gray-700">
            ...
            providers (e.g., Stripe). AskMeDirect does not store credit card or
        ...
        <div className="mb-6">
          <p className="text-gray-700">
            Our Services are accessible globally. By using AskMeDirect, you
            acknowledge that your data may be transferred and processed in
            countries outside your own, including those that may not have the
        ...
        <div className="mb-6">
          <p className="text-gray-700">
            AskMeDirect is not intended for individuals under the age of 18. We
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-700">
            ...
            <p className="text-wrap">
              A company registered in Hungary company registration no.
              01-09-430447, registered seat at 1138 Budapest, Gyöngyösi utca 4.
              Fsz. 4. ajtó
            </p>
          </p>
        </div>
