...
// const ArrowLeft = () => (
//   <svg width="24" height="24" fill="none"><path d="M15 6l-6 6 6 6" stroke="#64748B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
// );
// const ArrowRight = () => (
//   <svg width="24" height="24" fill="none"><path d="M9 6l6 6-6 6" stroke="#64748B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
// );
...
//   const next = () => setIndex(i => Math.min(feedback.length - cardsToShow, i + 1));

//   return (
//     <div className="bg-white border border-gray-200 rounded-xl mb-4 p-4 overflow-hidden">
//       <div className="flex items-center justify-between mb-2">
//         <span className="font-semibold text-base text-slate-900">Clients Feedback</span>
...
//           <button
//             onClick={next}
//             disabled={index >= feedback.length - cardsToShow}
//             className="p-1 rounded hover:bg-gray-100 disabled:opacity-40"
//           >
//             <ArrowRight />
//           </button>
...
//         {feedback.slice(index, index + cardsToShow).map((fb, idx) => (
//           <div key={idx} className="bg-gray-50 border border-gray-200 rounded-xl p-3 min-w-[260px] max-w-[320px] flex-1 flex flex-col gap-2">
...
//               {[...Array(5)].map((_, i) => (
//                 <svg key={i} width="16" height="16" fill="none">
//                   <path
//                     d="M8 2l2.09 4.26L14 6.27l-3.18 3.09L11.18 14 8 11.77 4.82 14l.36-4.64L2 6.27l3.91-.01L8 2z"
//                     fill={i < Math.round(fb.rating) ? "#FACC15" : "#E5E7EB"}
//                   />
//                 </svg>
//               ))}
...
const FeedbackSlider = ({ feedback }) => {
  ...
  const next = () => setIndex(i => Math.min(feedback.length - cardsToShow, i + cardsToShow));
