...
const Professionals = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-8 w-full mt-8">
      ...
      {/* Filters */}
      <div className="lg:w-1/4 w-full bg-white rounded-xl shadow p-6 mb-4 lg:mb-0">
      ...
      <div className="flex-1">
        ...
        {paginatedProfessionals.length === 0 ? (
          ...
          paginatedProfessionals.map((prof) => (
            <div
              key={prof.id}
              className={`flex items-center gap-6 bg-white rounded-xl shadow p-4 mb-6 border relative `}
            >
              <div className="relative">
                <img
                  src={prof.avatar}
                  alt={prof.name}
                  className={`w-40 h-52 rounded-xl object-cover ${
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-sm text-gray-600 mb-1 flex flex-wrap gap-2">
                  ...
                  {prof.associated && (
                    <span className="ml-2">
                      · associated with {prof.associated}
                    </span>
                  )}
                </div>
              ...
              <div className="flex flex-col items-center gap-3 min-w-[160px] h-[28vh] justify-between">
                <div>
                  <button className="bg-blue-600 text-white px-5 py-2 rounded-full font-semibold text-sm hover:bg-blue-700 transition"
                  onClick={() => {
