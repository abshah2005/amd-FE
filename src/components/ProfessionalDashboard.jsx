            ...
            <div>
              <div className="text-xs text-gray-500">
                {(() => {
                  ...
                  const diffMs = answerBy - today; // Difference in milliseconds

                  if (isNaN(diffMs)) return "Time is yet to be decided";

                  if (diffMs <= 0) return "Time passed"; // Handle past dates
