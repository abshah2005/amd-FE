...
const SignupForm = ({tailwindclass="md:w-1/2"}) => {
  ...
  return (
    <div className={`w-full ${tailwindclass} flex items-center justify-center p-2 rounded-lg`}>
      <div className="bg-white w-[85%] max-w-sm rounded-2xl shadow-sm p-5">
        ...
        <form className="space-y-4" onSubmit={handleEmailSignup}>
          ...
          <div className="text-xs text-gray-600 mb-6">
            <p>
              By clicking{" "}
              <span className="font-semibold">Agree & Join</span>, you agree to
              the AskMeDirect{" "}
              <a
                href="#"
